...
class Testphptravels_detail(unittest.TestCase):
    website_url = 'https://www.phptravels.net/login'
    detail = '//*[@id="yerevan deluxe hotel"]/div/div[2]/div/div[2]/div/a'
    ...
    def test_searching(self):
        ...
        time.sleep(4)
        click_any_details = driver.find_element(By.XPATH, self.detail)
        action.move_to_element(click_any_details).click().perform()
        time.sleep(4)
